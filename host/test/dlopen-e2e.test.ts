...
// Kernel may live at either the modern package-management path or the
// pre-overhaul host/wasm/ location. Accept whichever is present.
const hasKernel =
  existsSync(join(REPO_ROOT, "binaries", "kernel.wasm")) ||
  existsSync(join(REPO_ROOT, "local-binaries", "kernel.wasm")) ||
  existsSync(join(__dirname, "../wasm/wasm_posix_kernel.wasm"));
